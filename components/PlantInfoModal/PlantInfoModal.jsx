...
import {
    ...
    CloseButton,
    MetaBox
} from "./PlantInfoModal.style";

export default function PlantInfoModal({ onClose, plant_info }) {
                ...
                <DetailContainer>
                    ...
                    <Footer>
                        <MetaBox>
                            ...
                            <p>
                                <span>성장 높이 :</span>{" "}
                                {plant_info.growthHeight}
                                {plant_info.growthHeight === 150
                                    ? "cm 이상"
                                    : "cm"}
                            </p>
                        </MetaBox>
                        ...
                        <MetaBox>
                            <p>
                                <span>물주기 봄 :</span>{" "}
                                {plant_info.waterCycle[0]}
                            </p>
                            <p>
                                <span>물주기 여름 :</span>{" "}
                                {plant_info.waterCycle[1]}
                            </p>
                            <p>
                                <span>물주기 가을 :</span>{" "}
                                {plant_info.waterCycle[2]}
                            </p>
                            <p>
                                <span>물주기 겨울 :</span>{" "}
                                {plant_info.waterCycle[3]}
                            </p>
                        </MetaBox>
                    </Footer>
                </DetailContainer>
